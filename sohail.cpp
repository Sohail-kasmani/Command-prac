...
void vout(vector<int> &v){for (int i = 0; i < int(v.size()); ++i){cout<<v[i]<<" ";}}
void vout(vector<ll> &v){for (int i = 0; i < int(v.size()); ++i){cout<<v[i]<<" ";}}
void vout(vector<char> &v){for (int i = 0; i < int(v.size());
 ++i){cout<<v[i]<<" ";}}
